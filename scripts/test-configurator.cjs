...
assert.equal(Object.keys(materials).length,43);
...
console.log('PASS: 43 profiles, operation allowlists, MORU CRYSTAL/ULTRA/Bronze profiles, mirror/painted heat exclusions, legacy migration, invalid stored entries and whole millimetres.');
