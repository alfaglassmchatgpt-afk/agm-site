...
function agm_redesign_front_assets() {
    if (!(is_front_page() || is_page('kompleksnye-postavki') || is_page_template('page-agm-led.php') || is_page_template('page-agm-architects.php') || is_page_template('page-agm-furniture.php') || is_page_template('page-agm-private.php') || is_page_template('page-agm-glass.php') || is_page_template('page-agm-production.php') || is_page_template('page-agm-designers.php') || is_page_template('page-agm-catalog.php') || is_page_template('page-agm-mirror.php') || is_page_template('page-agm-tinted.php')) || is_admin()) { return; }
