...
function agm_order_render($html, $slug, $legacy = false) {
    ...
    $data = ['processingUrl' => home_url('/obrabotka-stekla-i-zerkal/'), 'current' => $slug, 'materials' => $registry, 'operations' => json_decode(file_get_contents($dir . '/operations.json'), true)];
