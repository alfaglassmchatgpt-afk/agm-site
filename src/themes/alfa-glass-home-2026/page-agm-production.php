<?php
/** Template Name: Наше производство — ALFAGLASS 2026 */
...
$html = file_get_contents(get_template_directory() . '/agm-production/index.html');
...
echo strtr(strtr($html, ['__AGM_HEADER__'=>$header,'__AGM_SPRITE__'=>$sprite[0]]), [
    ...
    '__AGM_PRODUCTION__'=>esc_url(get_template_directory_uri() . '/agm-production'),
